...
test("default templates mention the mandatory workspace skill flow", () => {
  ...
  assert.match(instructions, /Repo-specific workspace skills may be recommended based on the detected stack/);
  assert.match(instructions, /Use `Find Skills` to discover more workspace skills/);
