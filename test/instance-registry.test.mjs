...
test("deriveLocalRuntimeImage scopes local builds to the instance id", () => {
  assert.equal(
    ...
    "openclaw-repo-agent-runtime:0.3.0-repo-deadbeef"
  );
});
...
test("instance registry stores entries atomically", async () => {
  ...
  await upsertInstanceRegistryEntry(registryPath, {
    ...
    portManaged: true,
    telegramTokenHash: "",
    localRuntimeImage: "openclaw-repo-agent-runtime:0.3.0-repo-one",
  ...
  await upsertInstanceRegistryEntry(registryPath, {
    ...
    portManaged: true,
    telegramTokenHash: "",
    localRuntimeImage: "openclaw-repo-agent-runtime:0.3.0-repo-two",
